      ...
      <div className="absolute bottom-0 left-0 right-0 z-10 flex flex-col justify-center gap-6 bg-clrdark p-4 text-clrwhite">
        ...
        <div className="flex flex-col gap-0">
          ...
          >
            ...
            <span className="text-[8px] text-clrprimary no-underline">
              View page
            </span>
          </a>
        </div>
...
const ArtistContainer = () => {
  return (
    <div className="flex flex-col gap-8">
      <h3 className="relative w-fit skew-x-12 bg-clrdark bg-opacity-20 text-4xl font-black text-clrprimary md:text-5xl">
        Meet our Gentlemen:
      </h3>
